...
<div class="contenido">
    <div class="Inicio-row">
        <div class="Inicio-row-titulo text-center">
            ...
            <div class="Inicio-row-generacion text-center">
                ...
                {{ HTML::image('/images/general/generaciones/marco1ppal.jpg', null, ["width"=>"80px", "height"=>"124px"]) }}
            </div>
            <div class="Inicio-row-generacion text-center">
                <p>ERNESTO CHAGOYA LLAGUNO <br>1900 - 1975 </p>
                {{ HTML::image('/images/general/generaciones/marco2ppal.jpg', null, ["width"=>"118px", "height"=>"124px"]) }}
            </div>
            <div class="Inicio-row-generacion text-center">
                <p>PORFIRIO CHAGOYA HERNÁNDEZ <br>1924 - 1993 </p>
                {{ HTML::image('/images/general/generaciones/marco3ppal.jpg', null, ["width"=>"95", "height"=>"123px"]) }}
            </div>
            <div class="Inicio-row-generacion text-center">
                <p>PORFIRIO RAYMUNDO CHAGOYA MÉNDEZ <br>1948 - Presente</p>
                {{ HTML::image('/images/general/generaciones/marco4ppal.jpg', null, ["width"=>"99px", "height"=>"124px"]) }}
            </div>
            <div class="Inicio-row-generacion text-center">
    ...
    <div class="Inicio-row text-center sugerencia">
            <p>Sugerido por tradicion:</p>
            <a id="producto-link" href="">
                {{ HTML::image('', null, ["width"=>"100px", "height"=>"150px"] )}}
            </a>

            <p id="sugerencia-nombre"></p>
    </div>
